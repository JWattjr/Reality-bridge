    ...
    <section className="bubbly-card bg-white p-4">
      ...
      <div className="mt-3 flex flex-col gap-2 sm:flex-row">
        <input
          ...
          className="min-w-0 flex-1 rounded-full border-2 border-primary-900 bg-bg-base px-3 py-2 text-xs font-bold outline-none"
        />
        <button
          type="button"
          disabled={!canSubmit || busy !== null}
          onClick={() => run("claim")}
          className="rounded-full border-2 border-primary-900 bg-pastel-green px-4 py-2 text-xs font-bold disabled:opacity-50"
        >
        ...
        <button
          ...
          disabled={!canSubmit || busy !== null}
          onClick={() => run("refund")}
          className="rounded-full border-2 border-primary-900 bg-white px-4 py-2 text-xs font-bold disabled:opacity-50"
        >
