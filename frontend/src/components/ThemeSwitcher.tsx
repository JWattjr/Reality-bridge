...
export default function ThemeSwitcher({ compact = false }: { compact?: boolean }) {
  ...
  return (
    <label className="inline-flex items-center gap-1.5 rounded-full border-2 border-primary-900 bg-white/85 px-2.5 py-1.5 text-xs font-bold shadow-bubbly-hover backdrop-blur-sm">
