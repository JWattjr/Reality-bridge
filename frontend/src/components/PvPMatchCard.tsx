  ...
  return (
    <section className="bubbly-card bg-pastel-green p-4">
      <div className="mb-3 flex items-center justify-between gap-3">
        ...
        <span className="rounded-full border-2 border-primary-900 bg-white px-2 py-1 text-[10px] font-bold">
      ...
      <div className="mt-3 rounded-2xl border-2 border-primary-900 bg-white/70 p-3 text-xs font-bold">
      ...
      {state.match?.status === "RESOLVED" && (
        <div className="mt-3 rounded-2xl border-2 border-primary-900 bg-white p-3 text-xs font-bold">
