            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {CATEGORIES.map((cat) => (
                  <button
                    key={cat}
                    className="px-3 py-1.5 rounded-full border-2 border-[var(--color-primary-900)] text-xs font-bold hover:bg-[var(--color-pastel-blue)] transition-colors focus:bg-[var(--color-primary-900)] focus:text-white"
                  >
                    {cat}
                  </button>
                ))}
        ...
        >
          <div className="bubbly-card p-6 bg-gradient-to-br from-[var(--color-pastel-purple)] to-[var(--color-pastel-pink)] text-center">
            ...
            <div className="mt-4 bg-white/50 backdrop-blur-sm rounded-xl border-2 border-[var(--color-primary-900)] p-3 text-xs font-bold">
              <p>Event Link:</p>
              <p className="text-[var(--color-primary-500)] mt-0.5">proofplay.xyz/event/your-event-slug</p>
            </div>
          </div>
          ...
          <div className="flex gap-3">
            ...
            <button className="flex-1 bg-[var(--color-primary-900)] text-white font-bold py-3 rounded-2xl border-2 border-[var(--color-primary-900)] hover:bg-[var(--color-primary-700)] transition-colors">
              🚀 Launch Event
            </button>
          </div>
        </motion.div>
